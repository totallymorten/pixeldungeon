...
public abstract class AnimatedSprite extends PhysicalSprite
{
	...
	protected double msDelay = 100; // delay between sprite change
	...
	public void update(double ms)
	{
		...
		state = isAnimating() ? AnimState.ANIMATING : AnimState.STOPPED;
	...
	abstract protected boolean isAnimating();
